...
Project done during **Full Stack Software Engineering studies** at **ALX Software Engineering Program**. It aims to learn about basics commands, navigation, files and directrories in **Shell**.
...
## Files
All of the folloing files are script, except `school.mgc`:
